...
if (phoneElement) { phoneElement.innerText = docSnapshot.data().phone || ''; }
 ...
 // Define the progress stages and their corresponding Firestore fields
      const progressStages = [
        { field: 'progressStageBasicInfo', checkAttr: 'progress-check="basic-info"', crossAttr: 'progress-cross="basic-info"' },
        { field: 'progressStageCoordinator', checkAttr: 'progress-check="coordinator-details"', crossAttr: 'progress-cross="coordinator-details"' },
        { field: 'progressStageOpeningTimes', checkAttr: 'progress-check="opening-times"', crossAttr: 'progress-cross="opening-times"' },
        { field: 'progressStageMoreInfo', checkAttr: 'progress-check="more-info"', crossAttr: 'progress-cross="more-info"' },
        { field: 'progressStageCampaignPrefs', checkAttr: 'progress-check="campaign-prefs"', crossAttr: 'progress-cross="campaign-prefs"' },
      ];
